...
Die Installation unter Windows ist wie jedes andere Programm. Nachdem die Setup-Datei der Virtualisierungsmaschine herruntergeladen wurde, führt ein Doppelklick durch die Installationsroutine. Informationen zu den Systemanforderungen finden Sie [hier]({{%relref "snoke/requirements/_index.md"%}}).

## Ausführen der Setup

Mit der Maus können Sie einen `Doppelklick` ausführen.

{{% notice tip %}}
Linke Maustaste relativ schnell hintereinander drücken.
{{% /notice %}}

{{% notice note %}}
Windows führt die Installationsroutine aus.
{{% /notice %}}

{{% notice info %}}
Ein lustiger Balken zeigt den Fortschritt der Installation an.
{{% /notice %}}

{{% notice warning %}}
Während des Vorgangs Ihren PC nicht beenden, sonst gibts nen *warning* und alles ist im Arsch
{{% /notice %}}

## Installation

Die Installation läuft von janz alleene (Mohamad: Geht schon!).
